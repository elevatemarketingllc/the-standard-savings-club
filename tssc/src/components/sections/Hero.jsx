        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 bg-maroon-700 border border-maroon-600 px-4 py-2 mb-6">
              ...
              <span className="font-heading text-xs tracking-widest uppercase text-gold-400">Boise, Idaho</span>
            </div>

            <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold leading-none tracking-wide uppercase mb-6">
              Save At &<br />
              <span className="text-gold-400">Support Local</span><br />
              Idaho Businesses<br />
              Every Day.
            </h1>
            ...
            <div className="flex flex-wrap gap-6 mb-10 mt-8">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gold-500 rounded-full flex items-center justify-center text-white font-bold text-sm">$</div>
                <div>
                  <div className="font-heading text-sm tracking-wider uppercase text-gold-400">$10 Off Monthly</div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gold-500 rounded-full flex items-center justify-center text-white font-bold text-sm">%</div>
                <div>
                  <div className="font-heading text-sm tracking-wider uppercase text-gold-400">Save 15–75%</div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gold-500 rounded-full flex items-center justify-center text-white font-bold text-sm">🎙</div>
                <div>
                  <div className="font-heading text-sm tracking-wider uppercase text-gold-400">Weekly Live Zooms</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/join"
                className="inline-flex items-center justify-center gap-2 bg-gold-500 hover:bg-gold-600 text-white font-heading text-sm font-semibold tracking-widest uppercase px-8 py-4 transition-all duration-200 group">
                Join Now — $33/Month
                <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <a href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 border-2 border-maroon-500 hover:border-gold-500 hover:text-gold-400 text-white font-heading text-sm font-semibold tracking-widest uppercase px-8 py-4 transition-all duration-200">
                See How It Works
              </a>
            </div>
          ...
          <div className="hidden lg:block">
            <div className="bg-maroon-800 border border-maroon-600 p-8">
              <div className="text-center mb-8">
                <div className="font-heading text-gold-400 text-xs tracking-widest uppercase mb-2">Membership</div>
