    ...
    <section id="how-it-works" className="relative bg-maroon-900 text-white pb-28 pt-8 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-14">
          {steps.map(({ num, title, desc }) => (
            <div key={num} className="relative">
              <div className="font-heading text-7xl font-bold text-maroon-700 opacity-40 leading-none mb-4">{num}</div>
              <h3 className="font-heading text-lg uppercase text-maroon-200 mb-2">{title}</h3>
        ...
        <div className="text-center">
          <Link to="/join"
            className="inline-flex items-center gap-2 bg-maroon-700 hover:bg-maroon-800 text-white font-heading text-sm font-semibold tracking-widest uppercase px-10 py-4 transition-colors">
            Start Saving Today
          </Link>
