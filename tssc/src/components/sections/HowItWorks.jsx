    ...
    <section id="how-it-works" className="bg-maroon-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <div className="font-heading text-xs tracking-widest uppercase text-gold-400 mb-2">Simple Process</div>
        ...
        <div className="text-center">
          <Link to="/join"
            className="inline-flex items-center gap-2 bg-gold-500 hover:bg-gold-600 text-white font-heading text-sm font-semibold tracking-widest uppercase px-10 py-4 transition-colors">
            Start Saving Today
          </Link>
