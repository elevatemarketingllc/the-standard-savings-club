        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-heading text-4xl sm:text-5xl uppercase text-maroon-900 mt-2 mb-4">
              Own a<br /><span className="text-gold-500">Business?</span>
            </h2>
          ...
          <div className="space-y-6">
            {perks.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white border border-gray-100 shadow-sm p-6 flex gap-5 items-start group hover:border-maroon-200 transition-colors">
                <div className="w-12 h-12 bg-maroon-700 group-hover:bg-gold-500 rounded-full flex-shrink-0 flex items-center justify-center transition-colors">
            ...
            <div className="bg-maroon-700 text-white p-6">
              <p className="font-heading text-sm tracking-widest uppercase text-gold-400 mb-1">Partners Added Weekly</p>
