  ...
  return (
    <section className="bg-maroon-900 text-white py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="font-heading text-xs tracking-widest uppercase text-gold-400 mb-4">Join Today</div>
        <h2 className="font-heading text-5xl sm:text-6xl lg:text-7xl uppercase font-bold leading-none mb-6">
          Start Saving at<br /><span className="text-gold-400">Local Businesses</span><br />Today
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/join"
            className="inline-flex items-center justify-center gap-2 bg-gold-500 hover:bg-gold-600 text-white font-heading font-semibold tracking-widest uppercase px-10 py-5 text-lg transition-colors group">
            Join for $33/Month
            <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <a href="mailto:Join@thestandardsavingsclub.com"
            className="inline-flex items-center justify-center gap-2 border-2 border-maroon-500 hover:border-gold-500 hover:text-gold-400 text-white font-heading font-semibold tracking-widest uppercase px-10 py-5 text-lg transition-colors">
            Contact Us
          </a>
        </div>
