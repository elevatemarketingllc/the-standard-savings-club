        ...
        <div className="w-full max-w-md">
          <div className="bg-white border border-gray-200 shadow-sm p-8 text-center">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We sent a confirmation email to <strong>{form.email}</strong>. Click the link to verify your account and access your member benefits.
            </p>
            <p className="text-gray-400 text-xs mb-6">Don't see it? Check your spam folder.</p>
            <Link to="/login" className="block w-full bg-maroon-700 hover:bg-maroon-800 text-white font-heading font-semibold tracking-widest uppercase py-4 transition-colors text-center">
              Go to Login
            </Link>
          </div>
        </div>
