...
const partnerDeals = [
  { name: "Uncle Ben's Haircuts", deal: '$10 off every haircut', category: 'Grooming', note: 'Automatic at checkout — just show your membership' },
  { name: 'Cowboy Burger', deal: 'Members-only discount', category: 'Restaurant', note: 'Show your member card at the counter' },
  { name: 'Opal Teeth Whitening Studio', deal: 'Exclusive member rate', category: 'Beauty & Wellness', note: 'Mention The Standard Savings Club when booking' },
  { name: 'Boise Bug Bombers Pest Control', deal: 'Members-only pricing', category: 'Home Services', note: 'Reference your membership when calling' },
  { name: 'Erick Butler Elite Basketball Training', deal: 'Member discount on sessions', category: 'Sports Training', note: 'Mention your membership when signing up' },
  { name: 'Elevate Marketing', deal: 'Member consultation rate', category: 'Marketing', note: 'Contact directly and mention The Standard' },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="font-heading text-3xl sm:text-4xl uppercase font-bold">
                Welcome, {firstName}
              </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-gray-200 shadow-sm p-6">
              ...
              <div className="mt-5 pt-4 border-t border-gray-100">
                <p className="text-xs text-gray-400">Zoom link is emailed to members before each session. Check your inbox!</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2" id="discounts">
            ...
            <div className="space-y-3">
              {partnerDeals.map(({ name, deal, category, note }) => (
                <div key={name} className="bg-white border border-gray-200 shadow-sm p-5 flex items-start gap-4 hover:border-maroon-200 transition-colors">
